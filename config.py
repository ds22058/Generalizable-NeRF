...
def config_parser():
    ...
    #mark here for modify the default gpu from 0 to 1
    ...
    #mark here for modifying nume_source_view
    parser.add_argument(
        "--num_source_views",
        type=int,
        default=10,
    ...
    parser.add_argument("--n_iters", type=int, default=400000, help="num of iterations")
    parser.add_argument(
...
### mark here for adding parser
    parser.add_argument(
        "--few_shot_input",
        type=bool,
        default=False,
        help="set true if only few-shot input"
    )
    return parser
